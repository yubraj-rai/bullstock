...
function App() {
  const [
    getOwnedStocks,
    { data: ownedStocksData, loading: ownedStockLoading },
  ] = useLazyQuery(GET_OWNEDSTOCKS);
  const [verifyUser, { data: userData, loading: userLoading }] =
      ...
      <ScrollToTop>
        ...
        <Routes location={location} key={location.pathname}>
          ...
          <Route
            ...
            element={
              <StockPage
                ticker={useLocation().pathname.replace("/stock/", "")}
              />
            }
          />
