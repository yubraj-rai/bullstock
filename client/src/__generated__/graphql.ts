...
export type Query = {
  __typename?: 'Query';
  checkStripeAccountRequirements: StripeRequirementsResponse;
  getMarketNews: Array<MarketNews>;
...
export type QueryCheckStripeAccountRequirementsArgs = {
...
export type StripeRequirementsResponse = {
  __typename?: 'StripeRequirementsResponse';
...
export type User = {
  ...
  otpExpiry?: Maybe<Scalars['Date']['output']>;
...
export type LoginUserMutation = { __typename?: 'Mutation', loginUser: { __typename?: 'UserResponse', token?: string | null, user?: { __typename?: 'User', _id: string, username: string, createdAt: any, updatedAt: any, balance: number, stripeAccountId?: string | null, googleId?: string | null, otp?: string | null, otpExpiry?: any | null } | null } };
...
export type CheckStripeAccountRequirementsQueryVariables = Exact<{
  stripeAccountId: Scalars['String']['input'];
}>;


export type CheckStripeAccountRequirementsQuery = { __typename?: 'Query', checkStripeAccountRequirements: { __typename?: 'StripeRequirementsResponse', success: boolean, requirements: Array<string> } };
...
export const CheckStripeAccountRequirementsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"CheckStripeAccountRequirements"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"stripeAccountId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"checkStripeAccountRequirements"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"stripeAccountId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"stripeAccountId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"success"}},{"kind":"Field","name":{"kind":"Name","value":"requirements"}}]}}]}}]} as unknown as DocumentNode<CheckStripeAccountRequirementsQuery, CheckStripeAccountRequirementsQueryVariables>;
